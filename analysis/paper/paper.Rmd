...
Lastly, we also report the root mean squared error ($RSME = \sqrt{\frac{1}{n}  \sum_{i=1}^{n}{(y_i - \hat{y}_i)^2}}$) and mean absolute error ($MAE = \frac{1}{n}|y_i - \hat{y}_i|$) for the final model.
