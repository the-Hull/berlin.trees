...
We included planting bed area and the sum of exchangeable basic cation as a proxy for soil nutrient availability (point extractions), as well as the proportional coverage of local climate zone 6 (LCZ6; open mid-rise urban land cover, see @demuzere2019 and @stewart2012 for details) and adjacent building height (spatial averages).
