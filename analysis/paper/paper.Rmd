...
These e
In addition to this, younger trees are typically more rigorously managed and irrigated, which may (further) alter age-dependent temperature sensitivity.
We lack data on demographic differences in management to confirm this, and acknowledge that younger trees here also surpassed their establishment phase, which entails high mortality for recently planted individuals [@harris2017]  during which the above would not apply
