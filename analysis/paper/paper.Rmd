...
It thus complements quantitative and qualitative tools, such as the climate matching tool, ecological site classification or species-climate matrix [see @hirons2019; @roloff2009; @brune 2019; and references therein].


### Green infrastructure management, planning and open data

The availability and quality of green infrastructure data, such as street tree inventories, and environmental covariates, determines the confidence in any inference of infrastructure performance in relation to its given context (e.g., temperature, planting bed area). 
