...
g(E(DBH_i)) &=  f_j(age_i) + f_j(temp_i) + f(covariate_i) + c_{i,j} + \tau_{i,k} + \epsilon_i \\ 

g(E(DBH_i)) &= f_j(age_i) + f_j(temp_i) + f(covariate_i) + c_{i,j} + \tau_{i,k} + \epsilon_i  \\

g(E(DBH_i)) &= f_j(age_i) + f_j(temp_i) + c_{i,j} + \tau_{i,k} + \epsilon_i  \\
...
Above models were tested in combination with a global spatial smooth $f(utmx_i,utmy_i)$ to account for the spatial structure of observations, which reduced auto-correlation of model residuals to considerably (see supplemental information).
