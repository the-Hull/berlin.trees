...
These were compared to a sub-set of models without a spatial component (cf. Equation$~$\@ref(eq:gams-nocovariate), and Figure$~$\@ref(fig:fig-model-deviance) but not further discussed there).
...
Note, that Equation$~$\@ref(eq:gams-age) was considered as the appropriate null model for interpretations.
...
(ref:model-performance) Predicted vs. observed best model day2007 and LCZ6
...
(ref:heat-effect) Age group-dependent temperature effect; only within range
