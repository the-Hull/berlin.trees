...
(ref:temp-overview) Temp overviews; rows are landsat, berlin environmental atlas, and UrbClim, columns are morning, day/afternoon, night.

```{r fig-temp-overview, fig.cap="(ref:study-temp)",fig.width = 12, fig.height = 12, out.width="100%"}
...
(ref:cambial-effect) Contrasting growth trends for recent and earlier radial increments (i.e. stem growth)
...
(ref:model-deviance) Fig caption

```{r fig-model-deviance, fig.cap="(ref:model-dev)", out.width="100%", include=TRUE, eval=TRUE}
...
(ref:heat-effect) Age group-dependent temperature effect
