...
caption_trees <- "Binned age-distribution for trees in Berlin dataset, and entries missing age information."
caption_trees_short <- "Binned age-distribution for trees in Berlin dataset."
...
However, temperature may excert a non-linear control on absolute growth and, hence, applying a  method able to capture such dynamics may result in somewhat different effect sizes / behavior.
