...
Relationships derived via the GAM in Equation$~$\@ref(eq:gam-full) with LCZ6 as covariate show fairly consistent responses across age groups considering trajectories, yet they differ somewhat in shape (Figure$~$\@ref(fig:fig-heat-effect)) and considerably in absolute magnitude (i.e., slope in Fig.$\@ref(fig:fig-temp-sens)).
...
Notably, *Platanus acerifolia* showed an earlier reversal of sensitivity at age group 45-50 as compared to other species. This may be due to the stronger upward curvature towards the estimates' lower temperature limit (see respective panel in Figure$~$\@ref(fig:fig-heat-effect)).
...
**Figure$~$\@ref(fig:fig-heat-effect)**


**Figure \@ref(fig:fig-temp-sens)**
...
**Figure$~$\@ref(fig:fig-lcz6-effect)**
