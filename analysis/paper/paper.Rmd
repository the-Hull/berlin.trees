...
author:
  - Alexander G. Hurley$^{a *}$, Ingo Heinrich$^{a,b}$, ...
  - $^a$ *Geoforschungszentrum Potsdam, Section 4.3, Potsdam, Germany*
...
Including additional covariates thus resulted only in comparatively small buincreases of predictive skill
The inclusion of temperature and temperature-age interactions improved the predictive skill, with models including the LandSat-derived UHI measures performing best on average.
Note that non-temperature models containing planting bed area and $LCZ6_{\over{150~m}}$ alone outperformed several of those including other temperature measures and covariate combinations.
...
As $LCZ6_{\over{300~m}}$ only marginally increased performance compared to the null model (age only), the reference scale for the impact of the urban fabric (i.e., LCZ6) has a limit at $<300~m$.
Nutrient availability, similar to $LCZ6_{\over{300~m}}$, also only improved model performance marginally.
...
(ref:temp-sens) Temperature sensitivity of diameter growth centered on species-specific means for comparability and to aid interpretation of inter-specific differences. Lines and bands are from ordinary least squares fits on the GAM estimates in Fig.$~$\@ref(fig:fig-heat-effect) (A) and the corresponding coefficients (slopes, B). 
...
Contrastingly, *Acer pseudoplatanus* showed decreased absolute growth with higher temperatures; this corresponds with their classification as *not very suitable* under [@roloff2009].
*Platanus acerifolia* and *Acer platanoides* are considered *suitable* and *very suitable* under @roloff2009, yet show the greatest decline with temperatures here.
Indeed, several several studies reviewed in @brune2016 highlight *A. platanoides* as drought-tolerant.
...
Thus, as the majority of individuals were situated at the upper end of the temperature continuum, high temperature sensitivity may entail additional management due to faster turn-over - subsequent replacement by more appropriate species.
