...
This was deemed reasonable as Berlin's built-up area has not changed markedly over the past 50 years (i.e., from about 52 to 61 %) [@mohamed2017]. 
The utility of using this high-resolution data set of air temperatures over a derived urban heat island product was assessed by… 
...
For this study, the LCZ 2, representing dense mid-rise built up cover was used as a proxy for the degree of urbanization, and is the most frequent LCZ for Berlin [@fenner2017] (found ref in .
