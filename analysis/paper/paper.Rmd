...
### Green infrastructure management and planning
...
However, few additions or alterations to data collection and provision schemes would have greatly  enhanced the utility and applicability of the data sets applied here. Note that we acknowledge the financial and logistic constraints that authorities are subject to, yet the suggestions below are likely valuable for this and other urban green infrastucture initiatives.
...
Lastly, less abundant species, which represent canditates for future tree selection, could be assessed with higher-quality standards regarding points measured above, to build a more reliable data source even at potentially lower coverage demographically and spatially.
...
Here, biogeographical approaches aim to match natural (i.e., non-urban) species distributions within current bioclimatic envelopes with future conditions at a planting site at larger scales [e.g., @broadmeadow2005].
...
Our work extends this approach by identifying the heat space (i.e., UHI range) occupied by several key species.
This not only allows identifying species-specific and intra-specific (age-dependent) sensitivities to urban conditions, but can also inform how age cohorts may respond as temperatures at a given location shift along the present continuum in the future, while accounting for the impacts additional urban conditions (e.g., management, disturbance, urban fabric).
...
It thus complements quantitative and qualititaive tools, such as the climate matching tool, ecological site classification or species-climate matrix [see @hirons2019; @roloff2009; @brune 2019; and references therein].
