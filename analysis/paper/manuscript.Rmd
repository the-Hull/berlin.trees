...
It is located in North-Eastern Germany, and lies in the temperate zone with warm-humid climate (Dfb) according to the updated Köppen-Geiger classification [@beck2018], with mean annual temperature of approximately 10$^\circ C$ and precipitation of 575$~mm$ (Tempelhof weather station, German Weather Service DWD).
Berlin has low relief (approximately 30$~m$ to 60$~m$ with 120$~m$ at solitary peaks), and is centered around a glacial outwash valley (sands, gravel), bordered by two plateaus consisting of glacial till and clay in the North-East and South, as well as sands in the South-West.
...
It has a pronounced urban heat island, owing to its high degree of built-up and sealed surfaces, with air temperatures up to 12$^\circ C$ higher in urban compared to adjacent rural areas at night times [@fenner2014].

# General approach

- Assess differences in mean growth across age for individual species produced by environmental factors, including air temperature (or measure of urban heat island loading), soil characteristics and rooting area, adjacent building height) in a space-for-time approach
- Focus on street trees where species have a minimum of X individuals
- Account for potential differences in tree management by authorities
- Use flexible models that can produce curves of varying modality 
- Understand / confirm urban tree growth (assessed for single species)
...
- datacleanr
- adjusting bad records
- final original, final data set available online, with cleaning scripts
...
1. Temperature, environmental and urban controls on tree growth  
	+ Urban tree growth accelerated (BIWI data)
	+ Intra specific differences in UHI response (note temp. products)
	+ Sensitive trees in hot spots
	+ Other controls: soil, urban fabric, 
	+ Validity and limitations (spatial auto-correlation, data quality, coverage)
...
2. Implications:  
  + Policy / planning:  
    - tree species
	  - Increase temporal coverage and accuracy of surveys
		- which trees to prioritize for measurement campaigns (low-abundance species, highly sensitive)
		- Compare and Supplement species matrix etc. with these analyses  
		- Generate co-located environmental observations (e.g., micro-climate)
